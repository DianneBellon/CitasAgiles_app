...
public class InformacionCita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informacion_cita);
        ...
        dialog = new Dialog(InformacionCita.this);
        ...
        Okey.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(InformacionCita.this, "Okay", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
        ...
        Cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(InformacionCita.this, "Cancel", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
